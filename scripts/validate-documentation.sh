...
require_text .agents/skills/backport-adoption/SKILL.md 'Do not add concrete compatibility APIs to the pattern package.'

require_text CONTRIBUTING.md '## Sources of Truth'
require_text CONTRIBUTING.md '## Repository Boundary'
require_text CONTRIBUTING.md 'compatibility APIs must be implemented and owned by a consumer repository.'
...
require_text README.md 'It does not ship concrete Apple API backports.'
...
require_text AGENTS.md 'Concrete compatibility APIs are out of scope for `Sources/`.'
...
require_text docs/BACKPORT_ADOPTION_GUIDE.md 'Do not add concrete Apple API backports'
require_text docs/BACKPORT_ADOPTION_GUIDE.md 'view.backport.badge(unreadCount)'
require_text docs/BACKPORT_ADOPTION_GUIDE.md 'optional, supplementary information'
require_text README.md 'import SwiftUI'
...
require_text Sources/Backport.swift 'This package does not add'
require_text Sources/Backported.swift 'The package defines the namespace only.'
require_text Sources/ObjCRuntime+Backport.swift 'This extension only wraps'
require_text Sources/SwiftUI+Backport.swift 'This extension only wraps'

require_text Tests/DocumentationExamples.swift 'func badge(_ count: Int) -> some View'
require_text Tests/DocumentationExamples.swift 'content.badge(count)'
require_text Tests/DocumentationExamples.swift '.backport.badge(unreadCount)'

reject_text README.md 'AGENT-DOC:'
reject_text README.md 'modernFeature()'
reject_text README.md 'modernModifier()'
reject_text README.md 'normalizedTitle'
reject_text Tests/DocumentationExamples.swift 'normalizedTitle'
reject_text Sources/Backport.swift 'provides backport functionality'
reject_text Sources/ObjCRuntime+Backport.swift 'modern API features'
reject_text Sources/SwiftUI+Backport.swift 'modern SwiftUI features'
reject_text Sources/SwiftUI+Backport.swift 'access implementations of newer APIs'
reject_text Tests/DocumentationExamples.swift 'documentationRedirectEffect'
reject_text Tests/DocumentationExamples.swift 'documentationCompatibilityEffect'
reject_text Tests/DocumentationExamples.swift 'documentationPolyfillEffect'
reject_text Tests/DocumentationExamples.swift 'documentationNoOpEffect'
